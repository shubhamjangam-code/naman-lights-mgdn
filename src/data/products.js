export const PRODUCTS = [
  {
    ...
    tagline: "Architectural ring chandelier with hand-cut crystal prisms & dimmable warm LED core.",
    ...
    specs: {
      ...
      power: "48W",
      dimensions: "Ø 900mm × H 280mm (Suspension up to 2000mm)"
    }
  },
  {
    id: "nfl-002",
    ...
    tagline: "Precision-extruded aluminum cylinder pendant light for dining & bar counters.",
    ...
    image: "/images/monolith_pendant_custom.png",
    rating: 4.8,
    reviewsCount: 34,
    isFeatured: true,
    specs: {
  ...
  },
  {
    ...
    tagline: "Indirect dual-emission architectural wall sconce in brushed brass finish.",
  ...
  },
  {
    ...
    tagline: "Low-voltage magnetic recessed & surface track architecture with modular spot inserts.",
    ...
    isFeatured: true,
    specs: {
      lumens: "3,800 lm (Kit Standard)",
      cri: "> 95 CRI",
      kelvin: "Tunable White 2700K - 4000K",
      material: "Extruded Black Aluminum Track Rail",
      dimming: "Smart Zigbee / DALI / App Controlled",
      power: "48V Low Voltage DC",
      dimensions: "2000mm Track Rail + 4 Adjustable Spot Modules"
    }
  },
  {
    id: "nfl-005",
    ...
    tagline: "Natural Nero Marquina marble base with hand-blown smoked opal glass globe.",
    ...
    specs: {
      lumens: "850 lm",
      cri: "> 90 CRI",
      kelvin: "2200K - 2700K Warm Sunset",
  ...
  },
  {
    ...
    tagline: "Slim architectural linear pendant light for executive conference and dining tables.",
  ...
  },
  {
    ...
    tagline: "Grand spiral cascade Jhoomer with hand-cut crystal drops & champagne gold finish.",
  ...
  },
  {
    ...
    tagline: "Concentric glowing amber halo ring suspended with invisible tension wires.",
    ...
    image: "/images/pendant_minimal.png",
    rating: 4.8,
    reviewsCount: 17,
    isFeatured: false,
    specs: {
  ...
  },
  {
    ...
    tagline: "Sculptural fluted optical glass cylinder mounted on brushed gold wall plate.",
...

  {
    ...
    tagline: "Ultra-slim 15mm magnetic architectural recess track with glare-free COB spotlights.",
    ...
    isFeatured: false,
    specs: {
      lumens: "4,800 lm Total Output",
      cri: "> 98 CRI (True Color Render)",
      kelvin: "Smart Bluetooth Tunable 2700K - 5000K",
      material: "Matte Black Recessed Aluminum Track",
      dimming: "Tuya Smart / Casambi / DALI",
      power: "48V Safe DC Busbar",
      dimensions: "3000mm Recessed Track + 5 Spot Modules"
    }
  },
  {
    id: "nfl-012",
    ...
    tagline: "High-end palace style royal Jhoomer crafted with Swarovski-inspired cut crystal droplets.",
  ...
  },
  {
    ...
    tagline: "Hand-blown smoked glass orb pendant light with central golden filament cage.",
    ...
    image: "/images/table_globe_real.jpg",
    gallery: [
      "/images/table_globe_real.jpg",
      "/images/opal_globe_lamp_real.jpg",
      "/images/table_globe_real2.jpg"
    ],
    rating: 4.7,
    reviewsCount: 19,
    isFeatured: false,
  ...
  },
  {
    ...
    tagline: "IP65 weatherproof architectural outdoor wall light for exterior villa pillars & facade wash.",
    ...
    specs: {
      lumens: "1,600 lm",
      cri: "> 90 CRI",
      kelvin: "3000K Exterior Warm White",
  ...
  },
  {
    ...
    tagline: "Artisanal hand-brushed brass table lamp with adjustable optical hood & warm capacitive dimmer.",
  ...
  },
  {
    ...
    tagline: "Custom-cast Italian terrazzo base paired with a hand-blown frosted opal glass sphere.",
  ...
  },
  {
    ...
    tagline: "Natural solid ash wood tripod base with woven cylindrical beige linen lampshade.",
    ...
    image: "/images/table_ceramic_real.jpg",
    rating: 4.8,
    reviewsCount: 19,
    isFeatured: true,
    specs: {
...
export const CATEGORIES = [
  ...
  { id: "chandeliers", label: "Grand Chandeliers" },
